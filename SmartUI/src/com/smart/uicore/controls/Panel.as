package com.smart.uicore.controls
{
	...
	import com.smart.uicore.controls.managers.ComponentsManager;
	...
	import com.smart.uicore.controls.skin.TitleSkin;
	import com.smart.uicore.controls.skin.sourceSkin.PanelSourceSkin;
	...
	public class Panel extends UIComponent
	{
		...
		public static var titleTextFilter:Array = [ new GlowFilter(0xFFFFFF,1,12,12,1.5,1)];
		public static var titleTextHeight:int = 25;
		/**
		 * 
		...
		public function Panel()
		{
			...
			_compoWidth = 300;
			_compoHeight = 200;
			backgroundFilter = DefaultStyle.panelBackgroundFilter;
			filterBG = new Shape();
			...
			txt.height = tiHeight;
			txt.y = (tiHeight-titleTextHeight)/2;
			txt.y += DefaultStyle.fontExcursion*2;
		...
		{
			if(ComponentsManager.isResizeCheckPosition == false) return;
			if(this.stage.stageHeight == 0 || this.stage.stageWidth == 0) return;
