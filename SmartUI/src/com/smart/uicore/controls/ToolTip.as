package com.smart.uicore.controls
{
	...
	import com.smart.uicore.controls.skin.ToolTipSkin;
	...
	public class ToolTip extends UIComponent
	{
		 ...
		 */ 
		public static var alphaOut:Number = 0.25;
		/**
		...
		public function set tip(value:Object):void{
			...
			if(_tipValue is String){
				if(txt == null){
					...
					txt.x = paddingLeft;
					txt.y = paddingTop;
					txt.y += DefaultStyle.fontExcursion;
					txt.width =maxWidth;
					txt.wordWrap = true;
					txt.width = txt.textWidth+5;
					txt.height = txt.textHeight+5;
					txt.blendMode = BlendMode.LAYER;
					txt.filters = textFilter;
					_compoWidth = txt.width+paddingLeft*2-2;
					_compoHeight = txt.height+paddingTop*2;
					setSize(_compoWidth,_compoHeight);
		...
		public static function registerTip(interDisplay:InteractiveObject,tip:Object):void{
			...
			interDisplay.addEventListener(MouseEvent.MOUSE_DOWN,interOut);
		...
		public static function clearTip(interDisplay:InteractiveObject):void{
			...
			interDisplay.removeEventListener(MouseEvent.MOUSE_DOWN,interOut);
