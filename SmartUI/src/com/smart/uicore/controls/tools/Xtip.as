package com.smart.uicore.controls.tools
{
    ...
    import com.smart.uicore.controls.support.ObjectFactory;
	
	/**
	 * 通用的适用于任意显示对象（组件和非组件）的Tooltip提示 
	 * @author flashk
	 * 
	 */
    public class Xtip extends Sprite 
	{
		...
		public static var tipBackgroundLinkName:String = "ui.tooltipBackgroundAsset";
        ...
        public function set tip(value:Object):void
		{
            ...
            _bg.width = int(_compoWidth+textWidhtAdd);
            _bg.height = int(_compoHeight + textHeightAdd);
        ...
        private static function hideLinkTip(event:MouseEvent=null):void
		{
            ...
            if (nowLinkTip != null && nowLinkTip.parent != null) {
                ...
                setTimeout(removeLinkTip,55,nowLinkTip);
                nowLinkTip = null;
            }
            nowDis = null;
