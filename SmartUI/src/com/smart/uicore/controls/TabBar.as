package com.smart.uicore.controls 
{
	...
	import com.smart.uicore.controls.events.TabBarEvent;
	import com.smart.uicore.controls.events.TabCloseEvent;
	...
	import com.smart.uicore.controls.managers.StyleManager;
	import com.smart.uicore.controls.skin.ActionDrawSkin;
	import com.smart.uicore.controls.skin.TabBarSkin;
	import com.smart.uicore.controls.skin.sourceSkin.TabSourceSkin;
	 ...
	 **/
	[Event(name="tabClose",type="com.smart.uicore.controls.events.TabCloseEvent")]
	...
	public class TabBar extends UIComponent
	{
		...
		protected var _paddingTop:Number = 27;
		protected var nowContent:DisplayObject;
		protected var isHide:Boolean;
		protected var _isAutoResetXY:Boolean = false;
		 ...
		 * 
		 */
		public function getTabAt(index:uint):Tab
		{
			return tabs[index] as Tab;
		}
		...
		protected function viewContentByIndex(index:uint):void {
			...
			if(isAutoClip == true){
				box.scrollRect = new Rectangle(0,0,_compoWidth-_padding,_compoHeight-_paddingTop+7);
			}
