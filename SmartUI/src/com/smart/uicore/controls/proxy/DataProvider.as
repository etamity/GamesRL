...
package com.smart.uicore.controls.proxy
{
		
		import com.smart.uicore.controls.events.DataChangeEvent;
		import com.smart.uicore.controls.events.DataChangeType;
		 ...
		 */
		[Event(name="preDataChange", type="com.smart.uicore.controls.events.DataChangeEvent")]
		 ...
		 * @playerversion Flash 9.0
		 */
		[Event(name="dataChange", type="com.smart.uicore.controls.events.DataChangeEvent")]
		...
		public class DataProvider extends EventDispatcher {
			...
			public function removeItemAt(index:uint):Object {
				...
				if(arr[0].hasOwnProperty("destory")) arr[0].destory();
			...
			public function removeAll():void {
				...
				{
					if(data[i].hasOwnProperty("destory")) data[i].destory();
				}
