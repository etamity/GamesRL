...
{
	import com.smart.uicore.controls.events.UIComponentEvent;
	...
	import com.smart.uicore.controls.skin.VScrollBarSkin;
	import com.smart.uicore.controls.skin.sourceSkin.VScrollBarSourceSkin;
	 ...
	 **/
	[Event(name="scroll",type="com.smart.uicore.controls.events.UIComponentEvent")]
	 ...
	 **/
	[Event(name="scrollBarStartDrag",type="com.smart.uicore.controls.events.UIComponentEvent")]
	 ...
	 **/
	[Event(name="scrollBarStopDrag",type="com.smart.uicore.controls.events.UIComponentEvent")]
	...
	public class VScrollBar extends UIComponent
	{
		 ...
		 * 默认的连续按下上下箭头的滚动速度 
		 */
		public var defaultArrowFrameMoveSpeed:Number = 2;
		/**
		 * 滑进时的透明度变化速度 
		 */
