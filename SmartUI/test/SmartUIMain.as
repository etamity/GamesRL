package  
{
	...
	import com.smart.uicore.controls.ProgressBar;
	...
	import com.smart.uicore.controls.data.ListItem;
	import com.smart.uicore.controls.events.ListEvent;
	...
	public class SmartUIMain extends Sprite
	{
		...
		private function initUI():void
		{
			...
			_tab2SP.addChild(_display);
			_display.add("tab1",new SideAsset());
			_display.add("tab2",new SideAsset());
			_display.add("tab3",new SideAsset());
			_display.setStyle("font","");
			_display.setSize(170,329);
			_display.x=200;
